<?php
/**
 * Home Construction Theme functions and definitions
 *
 ...
 */
function home_construction_theme_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Home Construction Theme, use a find and replace
		* to change 'home-construction-theme' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'home-construction-theme', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'home_construction_theme_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'home_construction_theme_setup' );
 ...
 */
function home_construction_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'home_construction_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'home_construction_theme_content_width', 0 );
 ...
 */
function home_construction_theme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'home-construction-theme' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'home-construction-theme' ),
...
add_action( 'widgets_init', 'home_construction_theme_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function home_construction_theme_scripts() {
...
add_action( 'wp_enqueue_scripts', 'home_construction_theme_scripts' );
